...
const SponsorsStrip = () => {
  const sponsors = [
    { name: "CAF", logo: "/assets/sponsors//visa.png" },
    { name: "TotalEnergies", logo: "/assets/sponsors/1xbet.png" },
    { name: "Orange", logo: "/assets/sponsors/agl.png" },
    { name: "RAM", logo: "/assets/sponsors/air-maroc.png" },
    { name: "CAF", logo: "/assets/sponsors/danon.png" },
    { name: "TotalEnergies", logo: "/assets/sponsors/lonaci.png" },
    { name: "Orange", logo: "/assets/sponsors/puma.png" },
    { name: "RAM", logo: "/assets/sponsors/tecno.png" },
    { name: "CAF", logo: "/assets/sponsors/tetale.png" },
